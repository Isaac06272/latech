...
export default function ContentCard({
  ...
  return (
    <article className="bg-surface-container-lowest/80 rounded-sketchy p-gutter shadow-sm flex flex-col gap-element-gap hover:-translate-y-1 hover:rotate-1 transition-all duration-300 border-2 border-surface-variant/50 group cursor-pointer backdrop-blur-sm relative overflow-hidden">
      ...
      <ul className="list-disc pl-5 font-headline-md text-[15px] text-on-surface-variant flex flex-col gap-1 marker:text-outline-variant relative z-10">
        <li>{summary1}</li>
        <li>{summary2}</li>
      </ul>
